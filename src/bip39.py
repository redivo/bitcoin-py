...
def generate_random_words_list(mnemonic_sentence_size = 12):
    """
    Generate a random words list based on official BIP39 words.

    Parameters:
        mnemonic_sentence_size (int):   Number of words in mnemonic sentence to be generated

    Return:
        List of randomly generated official English BIP39 words
    """
    ...
    # BIP39 Definition:
    # First, an initial entropy of entropy_len bits is generated.
    entropy = random.getrandbits(entropy_len)
...
if __name__ == "__main__":
    ...
    load_wordlist()
    print("Seed: " + sentence_to_seed(words_to_sentence(generate_random_words_list(args.generate)),
                                             args.passphrase).hex())
